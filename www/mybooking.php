...
if (isset($userID)) {
  ...
  include 'resources/inc/getAllBookings.inc.php';
  include 'resources/inc/updateTime.inc.php';

  # Getting User conversations
  $bookings = getAllBookings($userID, $pdo);
  $int = "";
                  ...
                  <div class='col-md-12 col-sm-12 text-center'>
                    ...
                    <form method="POST">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <a class="btn btn-primary" type="button" href="mybooking.php"><?= __('Cancel')?></a>
                      ...
                      <table class="table table-striped projects">
                        <thead>
                          <tr>
                            ...
                            <th style="width: 10%"><?= __('Assistant')?></th>
                        ...
                        <tbody>
                          ...
                          <td><?= $int ?></td>
                            ...
                            <td>
                              <a href="mybooking.php?bookingID=<?= $booking['BookingID'] ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> <?= __('Edit')?></a>
                            </td>
                            <td>
                              <form method="POST">
                                <input type="hidden" name="cancelBookID" value="<?= $booking['BookingID'] ?>">
                              <button type="submit" class="btn btn-danger btn-xs" name="delete_entry"><i class="fa fa-trash-o"></i> <?= __('Cancel ')?></button>
                              </form>
                            </td>
                            <?php } else {?>
                            ...
                            <form method="POST">
                              <input type="hidden" name="cancelBookID" value="<?= $booking['BookingID'] ?>">
                              <button type="submit" class="btn btn-danger btn-xs" name="delete_entry"><i class="fa fa-trash-o"></i> <?= __('DELETE')?></button>
                            </form>
                            </td>
                            <td></td>
                            <?php } ?>
