            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php if (isset($_GET['AvailabilityID'])){ ?>
                  <div class='col-md-4 col-sm-4'>
                  <div class='col-md-12 col-sm-12 text-center'>
                    <h4><?= __('Edit availability time')?></h4>
                  </div>
                    <form method="POST">
                    ...
                    <?php } else {?>
                      ...
                      <table class="table table-striped projects">
                        <thead>
                          <tr>
                            <th style="width: 1%">#</th>
                            <th style="width: 10%"><?= __('Availability Start')?></th>
                            <th style="width: 10%"><?= __('Availability End')?></th>
